...
class ApiClient:
    ...
    def toStringValue(self, obj):
        """Convert a string or object to a string value.
    ...
    def toPathValue(self, obj):
        ...
        Returns:
            string -- quoted value
        """
        obj_str = self.toStringValue(obj)
        return urllib.quote(obj_str)
    ...
    def sanitizeForSerialization(self, obj):
        ...
        if type(obj) == type(None):
            ...
            return dict([(key, self.sanitizeForSerialization(val))
    ...
    def deserialize(self, obj, objClass):
        ...
        if type(objClass) == str or type(objClass) == unicode:
            if 'list[' in objClass:
        ...
        if objClass in [int, long, float, dict, list, str, unicode, bool]:
            return objClass(obj)
        ...
        for attr, attrType in instance.swaggerTypes.iteritems():
            if obj is not None and attr in obj and type(obj) in [list, dict]:
                value = obj[attr]
                if attrType in ['str', 'unicode', 'int', 'long', 'float', 'bool']:
