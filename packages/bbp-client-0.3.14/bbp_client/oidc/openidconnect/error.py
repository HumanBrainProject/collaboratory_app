...
class FlowTokenInfoError(Error):
    """Token validation problem."""
    pass


class FlowUserInfoError(Error):
    """Obtaining user info problem."""
    pass


class DataError(Error):
    """Problem with parsing response from the server."""
    pass
